...
fileNamesSrc=["App.test.js", "logo.svg", "reportWebVitals.js", "setupTests.js", "App.test.tsx", "reportWebVitals.tsx", "setupTests.tsx", "react-app-env.d.ts"]
fileNamesSrcEmpty=["App.css", "index.css",  "App.test.tsx"]
fileNamesSrcJSModify=["index.js", "App.js", "index.tsx", "App.tsx"]

# For js only, for tsx it is modified later..
...
for index,file in enumerate(fileNamesSrcJSModify):
    if os.path.exists(currDir+"/src/"+file):
        with open(currDir+"/src/"+file,"w") as nf:
            # For type script strict typechecking is required so...
            if(file.count(".tsx")>0):
                modifyContent[0] = "import React from 'react';\nimport ReactDOM from 'react-dom/client';\nimport './index.css';\nimport App from './App';\n\nconst root = ReactDOM.createRoot(document.getElementById('root') as HTMLElement);\nroot.render(\n\t<React.StrictMode>\n\t\t<App />\n\t</React.StrictMode>\n);"
            nf.write(modifyContent[index%2])
